...
void dynSmagSGS<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
dynSmagSGS<BasicTurbulenceModel>::dynSmagSGS
(
...
template<class BasicTurbulenceModel>
bool dynSmagSGS<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void dynSmagSGS<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
