...
void SGS_dS<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
SGS_dS<BasicTurbulenceModel>::SGS_dS
(
...
template<class BasicTurbulenceModel>
bool SGS_dS<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void SGS_dS<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
